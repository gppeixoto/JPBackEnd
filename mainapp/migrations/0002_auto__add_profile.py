...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mainapp_profile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='usuario', unique=True, to=orm['mainapp.Person'])),
        ))
    ...
    models = {
        ...
        u'mainapp.profile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'usuario'", 'unique': 'True', 'to': u"orm['mainapp.Person']"}),
