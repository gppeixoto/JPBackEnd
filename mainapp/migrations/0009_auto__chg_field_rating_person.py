...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.person'
        db.alter_column(u'mainapp_rating', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Profile']))

    def backwards(self, orm):

        # Changing field 'Rating.person'
        db.alter_column(u'mainapp_rating', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
