...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mainapp_event', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Evento de Mateus', max_length=50),
                      keep_default=False)

        # Adding field 'Event.description'
        db.add_column(u'mainapp_event', 'description',
                      self.gf('django.db.models.fields.CharField')(default='Futebolzinho la em casa!', max_length=2000),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mainapp_event', 'name')

        # Deleting field 'Event.description'
        db.delete_column(u'mainapp_event', 'description')
