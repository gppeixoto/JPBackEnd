...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mainapp_event', 'time')

        # Adding field 'Event.timeBegin'
        db.add_column(u'mainapp_event', 'timeBegin',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Event.timeEnd'
        db.add_column(u'mainapp_event', 'timeEnd',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mainapp_event', 'time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Event.timeBegin'
        db.delete_column(u'mainapp_event', 'timeBegin')

        # Deleting field 'Event.timeEnd'
        db.delete_column(u'mainapp_event', 'timeEnd')
