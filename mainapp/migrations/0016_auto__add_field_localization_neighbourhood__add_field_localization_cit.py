...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Localization.neighbourhood'
        db.add_column(u'mainapp_localization', 'neighbourhood',
                      self.gf('django.db.models.fields.CharField')(default='Parnamirim', max_length=200),
                      keep_default=False)

        # Adding field 'Localization.city'
        db.add_column(u'mainapp_localization', 'city',
                      self.gf('django.db.models.fields.CharField')(default='Recife', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Localization.neighbourhood'
        db.delete_column(u'mainapp_localization', 'neighbourhood')

        # Deleting field 'Localization.city'
        db.delete_column(u'mainapp_localization', 'city')
