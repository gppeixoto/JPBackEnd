...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mainapp_profile', (
        ...
        db.send_create_signal(u'mainapp', ['Profile'])

        # Adding model 'Sport'
        db.create_table(u'mainapp_sport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'mainapp', ['Sport'])

        # Adding model 'Rating'
        db.create_table(u'mainapp_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Profile'])),
            ('sport', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Sport'])),
            ('numberOfVoters', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('rating', self.gf('django.db.models.fields.FloatField')(default=2.5)),
        ))
        db.send_create_signal(u'mainapp', ['Rating'])

        # Adding model 'Tag'
        db.create_table(u'mainapp_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Profile'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('numberOfVoters', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'mainapp', ['Tag'])

        # Adding model 'Localization'
        db.create_table(u'mainapp_localization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('adress', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('neighbourhood', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'mainapp', ['Localization'])

        # Adding model 'Event'
        db.create_table(u'mainapp_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2)),
            ('localization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Localization'])),
            ('sport', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Sport'])),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('timeBegin', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('timeEnd', self.gf('django.db.models.fields.TimeField')(null=True)),
        ...
        db.send_create_signal(u'mainapp', ['Event'])

        # Adding M2M table for field persons on 'Event'
        m2m_table_name = db.shorten_name(u'mainapp_event_persons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'mainapp.event'], null=False)),
            ('profile', models.ForeignKey(orm[u'mainapp.profile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'profile_id'])

        # Adding model 'Comment'
        db.create_table(u'mainapp_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Event'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Profile'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'mainapp', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table(u'mainapp_profile')

        # Deleting model 'Sport'
        db.delete_table(u'mainapp_sport')

        # Deleting model 'Rating'
        db.delete_table(u'mainapp_rating')

        # Deleting model 'Tag'
        db.delete_table(u'mainapp_tag')

        # Deleting model 'Localization'
        db.delete_table(u'mainapp_localization')

        # Deleting model 'Event'
        db.delete_table(u'mainapp_event')

        # Removing M2M table for field persons on 'Event'
        db.delete_table(db.shorten_name(u'mainapp_event_persons'))

        # Deleting model 'Comment'
        db.delete_table(u'mainapp_comment')
