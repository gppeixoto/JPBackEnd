...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Search'
        db.create_table(u'mainapp_search', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('beginDate', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('endDate', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('startTime', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('endTime', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Profile'])),
        ))
        db.send_create_signal(u'mainapp', ['Search'])

        # Adding M2M table for field sports on 'Search'
        m2m_table_name = db.shorten_name(u'mainapp_search_sports')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('search', models.ForeignKey(orm[u'mainapp.search'], null=False)),
            ('sport', models.ForeignKey(orm[u'mainapp.sport'], null=False))
        ))
        db.create_unique(m2m_table_name, ['search_id', 'sport_id'])


    def backwards(self, orm):
        # Deleting model 'Search'
        db.delete_table(u'mainapp_search')

        # Removing M2M table for field sports on 'Search'
        db.delete_table(db.shorten_name(u'mainapp_search_sports'))
    ...
    models = {
        ...
        u'mainapp.search': {
            ...
            'beginDate': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'endDate': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'endTime': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mainapp.Profile']"}),
            'sports': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mainapp.Sport']", 'symmetrical': 'False'}),
            'startTime': ('django.db.models.fields.TimeField', [], {'null': 'True'})
        },
        u'mainapp.sport': {
