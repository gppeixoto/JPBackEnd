...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.creatorProfile'
        db.add_column(u'mainapp_event', 'creatorProfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='creatorProfile', null=True, to=orm['mainapp.Profile']),
                      keep_default=False)

        # Adding M2M table for field visible on 'Event'
        m2m_table_name = db.shorten_name(u'mainapp_event_visible')
    ...
    def backwards(self, orm):
        # Deleting field 'Event.creatorProfile'
        db.delete_column(u'mainapp_event', 'creatorProfile_id')

        # Removing M2M table for field visible on 'Event'
        db.delete_table(db.shorten_name(u'mainapp_event_visible'))
