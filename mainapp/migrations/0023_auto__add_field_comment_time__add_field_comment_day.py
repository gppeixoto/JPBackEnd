...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mainapp_comment', 'time')

        # Deleting field 'Comment.day'
        db.delete_column(u'mainapp_comment', 'day')
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(9, 56, 12, 990281)'})
        },
        u'mainapp.event': {
