...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sport on 'Search'
        m2m_table_name = db.shorten_name(u'mainapp_search_sport')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sport on 'Search'
        db.delete_table(db.shorten_name(u'mainapp_search_sport'))
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 8, 0, 0)'}),
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(11, 40, 9, 920000)'})
        },
        u'mainapp.event': {
