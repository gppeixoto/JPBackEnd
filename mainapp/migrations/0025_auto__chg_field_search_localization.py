...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Search.localization'
        db.alter_column(u'mainapp_search', 'localization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Localization'], null=True))

    def backwards(self, orm):

        # Changing field 'Search.localization'
        db.alter_column(u'mainapp_search', 'localization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mainapp.Localization']))
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(10, 24, 56, 278000)'})
        },
        u'mainapp.event': {
