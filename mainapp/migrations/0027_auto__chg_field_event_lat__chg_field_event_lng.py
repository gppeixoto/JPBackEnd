...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mainapp_event', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

        # Changing field 'Event.lng'
        db.alter_column(u'mainapp_event', 'lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

    def backwards(self, orm):

        # Changing field 'Event.lat'
        db.alter_column(u'mainapp_event', 'lat', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=7))

        # Changing field 'Event.lng'
        db.alter_column(u'mainapp_event', 'lng', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=7))
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(14, 31, 10, 491000)'})
        },
        u'mainapp.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '7'}),
            'lng': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '7'}),
