...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.opened'
        db.add_column(u'mainapp_event', 'opened',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.opened'
        db.delete_column(u'mainapp_event', 'opened')
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(19, 41, 40, 445000)'})
        },
        u'mainapp.event': {
