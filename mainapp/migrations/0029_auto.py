...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field arrived on 'Event'
        m2m_table_name = db.shorten_name(u'mainapp_event_arrived')
    ...
    def backwards(self, orm):
        # Removing M2M table for field arrived on 'Event'
        db.delete_table(db.shorten_name(u'mainapp_event_arrived'))
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(22, 23, 31, 952000)'})
        },
        u'mainapp.event': {
