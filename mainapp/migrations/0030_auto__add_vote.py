...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vote'
        db.create_table(u'mainapp_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voter', null=True, to=orm['mainapp.Profile'])),
            ('voted', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voted', null=True, to=orm['mainapp.Profile'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag', null=True, to=orm['mainapp.Tag'])),
            ('sport', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sport', null=True, to=orm['mainapp.Sport'])),
        ))
        db.send_create_signal(u'mainapp', ['Vote'])


    def backwards(self, orm):
        # Deleting model 'Vote'
        db.delete_table(u'mainapp_vote')
    ...
    models = {
        ...
        u'mainapp.comment': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(20, 35, 33, 573000)'})
        },
        u'mainapp.event': {
            'Meta': {'object_name': 'Event'},
            'arrived': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'arrived'", 'symmetrical': 'False', 'to': u"orm['mainapp.Profile']"}),
        ...
        u'mainapp.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sport': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sport'", 'null': 'True', 'to': u"orm['mainapp.Sport']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tag'", 'null': 'True', 'to': u"orm['mainapp.Tag']"}),
            'voted': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voted'", 'null': 'True', 'to': u"orm['mainapp.Profile']"}),
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voter'", 'null': 'True', 'to': u"orm['mainapp.Profile']"})
        }
    }
